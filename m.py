...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "CHALA JA BSDK PHELA BUY KAR:- @rishabgupta01."
...
def show_all_users(message):
    ...
    if user_id in admin_id:
        ...
        response = "ʙᴜʏ NOW :- @RISHABGUPTA01 ❄."
    bot.reply_to(message, response)
...
def show_recent_logs(message):
    ...
    if user_id in admin_id:
        ...
        response = "BUY NOW FROM :- @RISHABGUPTA01❄."
        bot.reply_to(message, response)
...
def welcome_start(message):
    ...
    response = f'''❄️ARA DARRU PITA HAI😅😅😅, {user_name}! BHAI BUY KARNA HOGA USE KARNE KA LIYE. ᴛᴏ ɢᴇᴛ ᴀᴄᴄᴇss.
